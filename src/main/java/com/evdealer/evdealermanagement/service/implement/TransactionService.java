...
public class TransactionService {
        ...
        @Transactional(readOnly = true)
        public PageResponse<TransactionPackageResponse> getAllTransactionsBySellerId(String sellerId,
                        Pageable pageable) {
                Page<PostPayment> page = postPaymentRepository.findByProductSellerIdOrderByCreatedAtDesc(sellerId,
                                pageable);
                ...
                List<TransactionPackageResponse> history = page.getContent().stream()
                                .map(payment -> TransactionPackageResponse.builder()
                                                ...
                                                .paymentMethod(payment.getPaymentMethod() != null
                                                                ...
                                                                : null)
                                                .packageName(payment.getPostPackage() != null
        ...
        @Transactional(readOnly = true)
        public PageResponse<TransactionPurchaseResponse> getAllTransactionsPurchaseByBuyerAndSellerId(String accountId,
                        Pageable pageable) {
                Page<PurchaseRequest> page = purchaseRequestRepository.findCompletedTransactionsByAccountId(accountId,
                                pageable);
        ...
        @Transactional(readOnly = true)
        public PageResponse<TransactionContractResponse> getAllTransactionsContractByBuyerAndSellerId(String accountId,
                        Pageable pageable) {
